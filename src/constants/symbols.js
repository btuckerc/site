...
export const bracketed = (text) => `${SYMBOLS.BRACKET_OPEN}${text}${SYMBOLS.BRACKET_CLOSE}`
...
export const decorativeBorder = (text) => `${SYMBOLS.TREE_CORNER} ${text} ${SYMBOLS.TREE_LINE}`